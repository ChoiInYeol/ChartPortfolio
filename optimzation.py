...
def main():
    ...
    for model in models:
        for window_size in window_sizes:
            ...
            cumulative_returns_df.to_csv(f'cumulative_returns_{model}{window_size}.csv', index=True)
            relative_performance.to_csv(f'relative_performance_{model}{window_size}.csv', index=True)
            up_prob_df.to_csv(f'up_prob_{model}{window_size}.csv', index=True)
