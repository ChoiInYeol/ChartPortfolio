...
class Trainer:
    ...
    def set_data(self):
        ...
        self.train_x = train_data[0].astype("float32") * scale
        self.train_y = train_data[1].astype("float32") * scale
        self.train_prob = train_data[2].astype("float32")
        self.train_dates = self.dates_dict['train']
        
        # Validation 데이터
        val_data = data_dict['val']
        self.val_x = val_data[0].astype("float32") * scale
        self.val_y = val_data[1].astype("float32") * scale
